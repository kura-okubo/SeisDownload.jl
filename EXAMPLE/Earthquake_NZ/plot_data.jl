...
#----------------#
finame = "./dataset/NZquake.jld2"

eventID = 3 # choose station and components from stationlist in SeisData
channel = "HHZ" # choose station and components from stationlist in SeisData
